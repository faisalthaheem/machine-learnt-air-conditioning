...
Adafruit_MQTT_Publish temperaturePublish = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/lounge/dht/Temperature");
Adafruit_MQTT_Publish humidityPublish = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/lounge/dht/Humidity");
